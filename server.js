...
app.post("/api/user/", (req, res, next) => {
    ...
    //     )`);
    var sql ='INSERT INTO user (first_name, last_name, email, phone, org, country) VALUES (?,?,?,?,?,?)'
    var params =[data.first_name, data.last_name, data.email, data.phone, data.org, data.country]
